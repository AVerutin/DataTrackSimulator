...
{
    public class MtsConnect
    {
        public bool Connected { get; private set; }
        private MtsTcpConnection _connection;
        ...
        public MtsConnect(string identity, string addr, int port, int timeout, int reconnect) 
        {
        ...
        public bool Connect ()
        {
            ...
            catch (Exception e)
            {
                ...
                Debug.WriteLine($"Ошибка при подключении к сервису MTSService {e.Message}");
                Connected = res;
            }
